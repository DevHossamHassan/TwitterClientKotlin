package com.letsgotoperfection.twitterclientkotlin.ui.custom;
...
public class CircledImageView extends ImageView {
    ...
    public CircledImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable
                .CircledImageView_twitter_client_kotlin_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable
                .CircledImageView_twitter_client_kotlin_border_color, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(R.styleable
                .CircledImageView_twitter_client_kotlin_border_overlay, DEFAULT_BORDER_OVERLAY);
        mFillColor = a.getColor(R.styleable.CircledImageView_twitter_client_kotlin_fill_color,
                DEFAULT_FILL_COLOR);
